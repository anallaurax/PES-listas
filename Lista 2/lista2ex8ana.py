...
divida_total = fatura * (1 + juros) ** qnt_meses # ** significa que ele multiplica a divida do mes mais a do outro mes 

print(f"Sua dívida após {qnt_meses} meses será de R$ {divida_total:.2f}")